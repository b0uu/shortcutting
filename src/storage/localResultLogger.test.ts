...
const result: TestResult = {
  ...
  skillPackSummary: { "selection-practice": 1 },
  hintSkillSummary: {},
  ...
  nextPracticeSuggestion: {
    ...
    difficulty: "standard",
    seedPack: "standard-v1",
    skillPack: "selection-practice",
    skillTag: "replacement",
    label: "practice replacement",
    rationale: "Based on your most common edit: replacement.",
  },
  isPersonalBest: true,
  shareChallengeId: "c1",
};
